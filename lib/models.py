...
def DeepConvNet_MI(nb_classes, Chans=64, Samples=256,
                is_denoising=False, dropoutRate=0.5):
    """ Keras implementation of the Deep Convolutional Network as described in
    Schirrmeister et. al. (2017), Human Brain Mapping.
    ...
    block1 = Conv2D(25, (1, 5),
                    input_shape=(1, Chans, Samples),
                    kernel_regularizer=l2(0.00001), bias_regularizer=l2(0.00001))(input_main)
    block1 = Conv2D(25, (Chans, 1),
                    kernel_regularizer=l2(0.001), bias_regularizer=l2(0.001))(block1)
    block1 = BatchNormalization(axis=1, epsilon=1e-05, momentum=0.1)(block1)
    block1 = Activation('elu')(block1)
    block1 = MaxPooling2D(pool_size=(1, 2), strides=(1, 2))(block1)
    block1 = Dropout(dropoutRate)(block1)
    ...
    block2 = Conv2D(50, (1, 5),
                    kernel_regularizer=l2(0.00001), bias_regularizer=l2(0.00001))(block1)
    block2 = BatchNormalization(axis=1, epsilon=1e-05, momentum=0.1)(block2)
    block2 = Activation('elu')(block2)
    block2 = MaxPooling2D(pool_size=(1, 2), strides=(1, 2))(block2)
    block2 = Dropout(dropoutRate)(block2)
    ...
    block3 = Conv2D(100, (1, 5),
                    kernel_regularizer=l2(0.00001), bias_regularizer=l2(0.00001))(block2)
    block3 = BatchNormalization(axis=1, epsilon=1e-05, momentum=0.1)(block3)
    block3 = Activation('elu')(block3)
    block3 = MaxPooling2D(pool_size=(1, 2), strides=(1, 2))(block3)
    block3 = Dropout(dropoutRate)(block3)
    ...
    block4 = Conv2D(200, (1, 5),
                    kernel_regularizer=l2(0.00001), bias_regularizer=l2(0.00001))(block3)
    block4 = BatchNormalization(axis=1, epsilon=1e-05, momentum=0.1)(block4)
    block4 = Activation('elu', name='last_conv_out')(block4)
    block4 = MaxPooling2D(pool_size=(1, 2), strides=(1, 2))(block4)
    block4 = Dropout(dropoutRate)(block4)
...
def ShallowConvNet(nb_classes, Chans=64, Samples=128, is_denoising=False, dropoutRate=0.5):
    ...
    # get_custom_objects().update({'log': log})

    get_custom_objects()['square'] = square
    get_custom_objects()['log'] = log
    # start the model
    input_main = Input((1, Chans, Samples))
